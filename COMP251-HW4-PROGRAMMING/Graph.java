...
public class Graph {
    ...
    public void contractEdge(Edge edge_to_contract) {
        ...
        removeEdge(edge_to_contract);

        Iterator<Edge> edgeIterator = Graph.this.getEdges().iterator();
        while(edgeIterator.hasNext()){
            Edge edge = edgeIterator.next();
            if((edge.node_1==u&&edge.node_2==v)||(edge.node_2==u&&edge.node_1==v)){
                edgeIterator.remove();
            }
        }
        for(Edge edge : getEdges()){
            ...
            else if (edge.node_2==u){
                edge.node_2=v;
            }
        }
        Graph.this.removeNode(u);
